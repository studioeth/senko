...
{ 
  ...
  unsigned short xOut = rMatrix[y][x].x;
  unsigned short yOut = rMatrix[y][x].y;
  //if(xOut < 16 && yOut < 16){
    firstframe.SetPoint(yOut+4, xOut+4);
    firstframe.RefreshAll(10); //Draw frame buffer one time
  //}
}
